...
export function GameBoard({
  ...
  const nextPieceSize = cellSize * 0.75;

  return (
    <div className="relative mx-auto" style={{ width: boardWidth }}>
      {nextPiece && (
        <div
        ...
        >
          <span className="mb-1 text-[10px] font-medium text-gray-500">NEXT</span>
          <div
          ...
          {board.map((row, rowIndex) =>
            row.map((tile, colIndex) => {
              ...
              const isColumnHighlight =
                hoverCol === colIndex && canInteract && canPlaceInColumn(board, colIndex);
              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    isColumnHighlight ? "bg-indigo-900/40 ring-1 ring-indigo-400/40" : "",
